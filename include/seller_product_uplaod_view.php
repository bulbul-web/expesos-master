        ...
        <div class="container">
            <div class="page-linker border-0">
                <ul class="p-0">
                    ...
                    <li><span>/</span></li>
                    <li><a href="product-details.html" class="active">Products details</a></li>
                </ul>
            </div>
        </div>
    </section> -->
                                    ...
                                    <div class="card-body">
                                        <div class="row mb-5 mt-2">
                                            ...
                                            <div class="col-12 col-md-6">
                                                ...
                                                <span class="sku">
                                                6d 23h | <b>Friday, 7:43PM</b> </span><br>
                                                </span>
                                                ...
                                                <div class="content-form">
                                                    <form action="post" class="bid-form">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="product-details-input form-group">
                                                                    <label class="font-weight-bold">Starting BID :</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <button class="btn btn-info mr-0 mr-sm-1 mb-2 mb-sm-0 own-btn">Place Bid</button>
                                                                <button class="btn btn-outline-danger own-btn"><i class="fa fa-heart mr-2"></i>Add to wish list</button>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="product_meta">
                                                    ...
                                                    <span class="sku">
                                                    Seller does not accept returns </span><br>
                                                    </span>
                                                </div>
                                                <hr>
